...
document.querySelector('#contact-form').addEventListener('submit', (e) => {
  ...
  function sendToWhatsApp(event) {
    ...
    const text = `Hello! My name is ${name}.%0AMy email: ${email}%0AMy number: ${phone}%0ASubject: ${subject}%0AMessage: ${message}`;

    // Ganti nomor di bawah dengan nomor WhatsApp tujuan (gunakan format internasional tanpa +)
    const phoneNumber = "6285885393416";
